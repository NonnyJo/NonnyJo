...
local SelfModules = {
	UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/NonnyJo/NonnyJo/main/UI.lua"))(),
	Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/NonnyJo/NonnyJo/main/Functions.lua"))(),
}
